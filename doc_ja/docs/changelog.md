...
## v2.0 (2026/05/23)
- Maskedマテリアルでの描画と影の描画に対応しました。

## v1.17 (2026/02/03)
- 大きなモデルを描画する際に正しく描画できない問題を修正しました。（Positionテクスチャがfloat16ではなくfloat32を使用するようになりました）

## v1.16 (2026/01/16)
- エディタビューポート上でもブロックが正しい順序で描画されるよう修正しました。

## v1.15 (2025/08/08)
- より多くの.plyファイルに対応しました。
